  	...
  	render() {
		...
		<div className='my-component'>
			<div className='webLink' style = {divStyle}>
				<a className ="linkMeet" href={urlLink1} target="_blank">Find Activeties Within 1 miles</a><p/>
				<a className ="linkMeet" href={urlLink2} target="_blank">Find Activeties Within 10 miles</a><p/>
				<a className ="linkMeet" href={urlLink3} target="_blank">Find Activeties Within 20 miles</a><p/>
			</div>
